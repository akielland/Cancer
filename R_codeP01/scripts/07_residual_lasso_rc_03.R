...
lasso_residual_rep_cv <- function(df_data, pred_mech, additive=TRUE, func=lasso_sample, folds=5, repeats=200, method="pearson") {
...
set.seed(123)
lc_obj_residuals_771_p_m <- lasso_residual_rep_cv(prolif_771genes, pred_mech, additive=FALSE, func=lasso_sample, folds, repeats, method="pearson")
...
set.seed(123)
lc_obj_residuals_771_ROR_p_a <- lasso_residual_rep_cv(RORprolif_771genes, pred_mech, additive=TRUE, func=lasso_sample, folds, repeats, method="pearson")
head(lc_obj_residuals_771_ROR_p_a$coef_matrix)[,1:6]
save(lc_obj_residuals_771_ROR_p_a, file="/Users/anders/Documents/MASTER/Cancer/R_codeP01/instances/lc_obj_residuals_771_ROR_p_a.RData")
load("/Users/anders/Documents/MASTER/Cancer/R_codeP01/instances/lc_obj_residuals_771_ROR_p_a.RData")

# RUN: lc_obj_residuals_771_ROR_p_m (multiplicative)
set.seed(123)
lc_obj_residuals_771_ROR_p_m <- lasso_residual_rep_cv(RORprolif_771genes, pred_mech, additive=FALSE, func=lasso_sample, folds, repeats, method="pearson")
head(lc_obj_residuals_771_ROR_p_m$coef_matrix)[,1:6]
save(lc_obj_residuals_771_ROR_p_m, file="/Users/anders/Documents/MASTER/Cancer/R_codeP01/instances/lc_obj_residuals_771_ROR_p_m.RData")
