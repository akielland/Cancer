...
e_b_obj_771_p$co_matrix <- t(e_b_obj_771_p$co_matrix)
head(e_b_obj_771_p$co_matrix)[,1:6]
...
head(e_c_obj_771_prolif$co_matrix)[,1:6]
...
head(e_c_obj_771_RORprolif$co_matrix)[,1:6]
...
gene_freq <- function(matrix, name, n_models=1000){
  ...
  h <- ggplot(frequency[frequency$Frequency >= perc_best30,], aes(x = Frequency, y = reorder(Feature, Frequency))) +
...
gene_freq(e_b_obj_771_p$co_matrix, "elastic_90perc_b_p")
gene_freq(e_b_obj_771_RORprolif, "elastic_90perc_b_ROR")
gene_freq(e_c_obj_771_prolif, "elastic_90perc_r_p")
gene_freq(e_c_obj_771_RORprolif, "lasso_90perc_r_ROR")
