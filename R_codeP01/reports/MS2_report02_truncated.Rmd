...
options(digits=3)
data_table <- data.frame(
  Model = c("Lasso", "Ridge", "ElasticNet", "Boosting", "Residual (lasso/additive)", 
...
rounded_data_table <- data_table |>
  mutate_if(is.numeri, round, digits = 3)

kable(rounded_data_table)
```
