...
1. Repeated cross-validations (200 repeats of 5 fold cross-validation)
...
### Group lasso (not done)
### Sparse group lasso (done)
...
### Summery results: lasso 771 genes bootstrap and repeated cross-validation
```{r}
data_table <- data.frame(
  Model = c("prolif boot", "ROR-prolif boot", "prolif rep cross-val", "ROR-prolif rep cross-val"),
  cor_mean = c(l_b_771_p$cor_mean, l_b_771_ROR_p$cor_mean, l_c_771_p$cor_mean, l_c_771_ROR_p$cor_mean),
  sd_cor = c(l_b_771_p$cor_sd, l_b_771_ROR_p$cor_sd, l_c_771_p$cor_sd, l_c_771_ROR_p$cor_sd),
  MSE_mean = c(l_b_771_p$MSE_mean, l_b_771_ROR_p$MSE_mean, l_c_771_p$MSE_mean, l_c_771_ROR_p$MSE_mean),
  MSE_sd = c(l_b_771_p$MSE_sd, l_b_771_ROR_p$MSE_sd, l_c_771_p$MSE_sd, l_c_771_ROR_p$MSE_sd)
)
kable(data_table)
```
...
### Mechanistic + Residuals (additive) -> ROR-proliferation score  (lasso - bootstrap)
```{r}
...
### Mechanistic + Residuals (multiplicative) -> ROR-proliferation score (lasso - bootstrap)
```{r}
...
### Mechanistic + Residuals (additive) -> ROR-proliferation score (lasso - repeated cross-validation)
```{r}
...
### Mechanistic + Residuals (multiplicative) -> ROR-proliferation score (lasso - repeated cross-validation)
```{r}
...
### Summery results Mechanistic: lasso proliferation score (bootstrap) 
```{r}
library(knitr)
data_table <- data.frame(
...
### Summery results Mechanistic: lasso ROR+proliferation score (bootstrap) 
```{r}
data_table <- data.frame(
  Model = c("lasso 6 genes", "lasso 771 genes", "Nodes", "Residual additive", "Residual multiplicative"),
...
### Summery results Mechanistic: lasso proliferation score (repeated cross-validation) 
```{r}
library(knitr)
data_table <- data.frame(
  Model = c("lasso 6 genes", "lasso 771 genes", "Nodes", "Residual additive", "Residual multiplicative"),
...
### Summery results Mechanistic: lasso ROR+proliferation score (repeated cross-validation) 
```{r}
data_table <- data.frame(
  Model = c("lasso 6 genes", "lasso 771 genes", "Nodes", "Residual additive", "Residual multiplicative"),
...
### Lasso/pca: 771 genes -> ROR-proliferation score
```{r}
...
### ElasticNet/pca: 771 genes -> ROR-proliferation score
```{r}
...
### Ridge/stack: 771 genes -> ROR-proliferation score
```{r}
...
### Ridge/stack: 771 genes -> ROR-proliferation score + interactions between base models
```{r}
...
### Lasso/stack: 771 genes -> ROR-proliferation score
```{r}
...
### Lasso/stack: 771 genes -> ROR-proliferation score + interactions between base models
```{r}
...
### ElasticNet/stack: 771 genes -> ROR-proliferation score
```{r}
...
### ElasticNet/stack: 771 genes -> ROR-proliferation score + interactions base models
```{r}
...
# Summary using Mechanistic model
