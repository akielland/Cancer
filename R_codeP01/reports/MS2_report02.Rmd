...
The gene set is dived into X numbers of "signature genes"; which are thought to represent functional unities with respect to cancer biology...overview of signatures..

Additionally, both data-set contians clinical data as...
(how to model in...)
